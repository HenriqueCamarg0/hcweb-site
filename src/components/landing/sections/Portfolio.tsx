  ...
  return (
    <section className="section-pad relative overflow-hidden" id="portfolio">
      ...
      <div className="relative mx-auto max-w-6xl px-4">
        <SectionHeader
          category="Portfólio"
          title="Demonstrações reais, para você ver na prática."
          description="Clique em qualquer card abaixo e veja o site funcionando de verdade, no navegador."
        />
